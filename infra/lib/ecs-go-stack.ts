...
interface EcsGoStackProps extends cdk.StackProps {
  environment: string;
}

export class EcsGoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: EcsGoStackProps) {
    ...
    new cdk.CfnOutput(this, "ApiRepositoryUri", {
      ...
      description: "ECR repository URI — use this to push Docker images",
